...
namespace ELearning_ToanHocHay_Control.Services.Interfaces
{
    ...
    {
        Task<ApiResponse<IEnumerable<ExerciseDto>>> GetAllAsync(bool freeOnly = false);
        ...
        Task<ApiResponse<IEnumerable<ExerciseDto>>> GetByLessonIdAsync(int lessonId, bool freeOnly = false);
        Task<ApiResponse<IEnumerable<ExerciseDto>>> GetByChapterIdAsync(int chapterId, bool freeOnly = false);
        Task<ApiResponse<IEnumerable<ExerciseDto>>> GetByTopicIdAsync(int topicId, bool freeOnly = false);
